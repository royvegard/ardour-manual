...
typical editor window is shown in Figure~\ref{fig:mixer-summary}.
...
session, so that is available after closing and re-opening a session.
This is very useful in case you make some mistake, or change your mind
about an edit.  Storing this information does require memory and disk
space, however, so options here allow you to specify how many commands
are stored in memory, and how many are written to disk.
