...
clicking the tool (\includegraphics{screenshots/tool-region-gain.png}).  Now,
...
stretch/shrink tool (\includegraphics{screenshots/tool-stretch.png}).
...
`edit region contents' tool (\includegraphics{tool-region-contents}).
...
(\includegraphics{tool-objects.png}) you can select notes, move them
...
(\includegraphics{tool-draw-midi.png}).  Select this tool, then click
